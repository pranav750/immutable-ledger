...
const HackBlock = ({ indexChangeHandler, hackedDataChangeHandler, blockSubmitHandler, blockNumberHandler, blockNumber, isChainValid, length, index, distributed }) => {
